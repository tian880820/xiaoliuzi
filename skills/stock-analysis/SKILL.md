---
name: stock-analysis
description: Comprehensive US stock and crypto analysis with 8-dimension analysis, portfolio management, watchlists, alerts, dividend analysis, and viral trend detection.
metadata:
  {
    "openclaw":
      {
...
- 🛑 Stop Hit — Price <= stop
- 📊 Signal Change — BUY/SELL/HOLD rating change
...
- ⚠️ **Pre-Earnings** — Warns if 15% in 5 days
