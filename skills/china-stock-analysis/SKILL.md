...
description: Analyze Chinese stock prices and provide investment recommendations. Supports A-shares, HK stocks, and US stocks.
metadata:
  {
    "openclaw":
      {
...
1. **Search for current price data** using web search or searxng
